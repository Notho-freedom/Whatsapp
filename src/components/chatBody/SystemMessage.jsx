  ...
  if (message.systemType === 'call' || message.systemType === 'video') {
    ...
    return (
      <div className="wa-message-container flex justify-start">
        <div 
          className="flex items-center gap-3 px-4 py-2 rounded-lg max-w-[380px]"
        ...
        >
          ...
          <div className="flex-1">
            <div className="text-[14px] text-[#e9edef] mb-0.5">
          ...
          {StatusIcon && (
            <StatusIcon size={20} style={{ color: statusColor }} className="flex-shrink-0" />
          )}
        </div>
      </div>
    );
      ...
      <div className="wa-date-divider">
        <div className="wa-date-divider-text flex items-center">
          {message.systemType === 'encryption' && (
            <FaLock size={10} className="mr-1.5" />
          )}
