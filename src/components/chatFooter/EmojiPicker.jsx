...
import { Search, Smile, Heart, Hand, Apple, Activity, Plane, FileText, Hash, Flag } from 'lucide-react';

const EMOJI_CATEGORIES = [
  { id: 'recent', icon: Smile, label: 'Récents' },
  { id: 'smileys', icon: Smile, label: 'Smileys' },
  { id: 'hearts', icon: Heart, label: 'Cœurs' },
  { id: 'gestures', icon: Hand, label: 'Gestes' },
  { id: 'food', icon: Apple, label: 'Nourriture' },
  { id: 'activity', icon: Activity, label: 'Activités' },
  { id: 'travel', icon: Plane, label: 'Voyage' },
  { id: 'objects', icon: FileText, label: 'Objets' },
  { id: 'symbols', icon: Hash, label: 'Symboles' },
  { id: 'flags', icon: Flag, label: 'Drapeaux' }
];
...
export default function EmojiPicker({ isOpen, onClose, onEmojiSelect }) {
  ...
  useEffect(() => {
    // Charger les emojis récents depuis le localStorage
