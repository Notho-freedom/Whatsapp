...
export default function ChatHeader({ selectedChat }) {
  ...
  // Récupérer la présence et les typing users du contexte global
  const { presence, typingUsers } = useAppContext();
      ...
      <div className="flex items-center gap-3 p-[1px]">
        ...
        >
          <img
            ...
            src={
              selectedChat.avatar ||
              `https://placehold.co/40x40/png?text=${selectedChat.name.charAt(
                0
              )}`
            }
          />
            ...
            {(() => {
              ...
              if (userPresence) {
                if (userPresence.status === 'online') {
                  ...
                  return `dernière connexion ${new Date(
              ...
              return (
                selectedChat.status || "dernière connexion aujourd'hui à 18:39"
              );
            })()}
          </p>
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-0 items-center bg-neutral-700/50 border border-neutral-700 backdrop-blur-sm rounded-md">
          <button
            ...
            onClick={() => {
              ...
              window.dispatchEvent(
                new CustomEvent('video-call-started', {
                  detail: {
                    participant: selectedChat,
                    fromChat: true,
                    timestamp: new Date(),
          ...
          <button
            ...
            onClick={() => {
              ...
              window.dispatchEvent(
                new CustomEvent('voice-call-started', {
                  detail: {
                    participant: selectedChat,
                    fromChat: true,
                    timestamp: new Date(),
        ...
        <button
          ...
          onClick={() => {
            ...
            window.dispatchEvent(
              new CustomEvent('chat-search-opened', {
                detail: {
                  chatId: selectedChat.id,
                  participant: selectedChat,
                  timestamp: new Date(),
        ...
        <button
          ...
          onClick={() => {
            ...
            window.dispatchEvent(
              new CustomEvent('open-chat-menu', {
                detail: {
                  chatId: selectedChat.id,
                  participant: selectedChat,
                  action: 'show-menu',
            ...
            window.dispatchEvent(
              new CustomEvent('chat-menu-opened', {
                detail: {
                  chatId: selectedChat.id,
                  participant: selectedChat,
                  timestamp: new Date(),
