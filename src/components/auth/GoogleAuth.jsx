    ...
    <div className="flex justify-center mb-8">
      <div className="relative group w-full max-w-xs">
        ...
        <button
          ...
          disabled={isLoading}
          className="relative w-full bg-white/10 backdrop-blur-xl border border-white/20 text-white py-4 px-4 rounded-2xl font-medium focus:outline-none focus:ring-4 focus:ring-whatsapp-primary/50 focus:ring-offset-2 focus:ring-offset-whatsapp-dark-900 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-4 group-hover:bg-white/20 group-hover:border-white/30 group-hover:scale-[1.02] transform shadow-lg"
        >
          {isLoading ? (
            <>
            ...
            <>
              ...
              <span className="text-sm group-hover:tracking-wide transition-all duration-300">
    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto text-center px-4">
        ...
        <div className="mb-12 flex justify-center">
          <div className={`w-28 h-28 transition-all duration-700 ease-out ${
       ...
       <div className="text-center mb-12 animate-fadeIn" style={{animationDelay: '0.2s'}}>
         <h1 className="text-3xl font-light text-white mb-3 tracking-wider font-segoe">
           WhatsApp
         </h1>
         <p className="text-whatsapp-secondary text-md font-light">
       ...
       <div className="text-center mt-16">
         <p 
           className="text-whatsapp-secondary text-xs font-light cursor-pointer hover:text-whatsapp-primary transition-colors duration-300"
