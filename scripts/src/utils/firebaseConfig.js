...
import { getDatabase, ref, set, get, onValue, off, push, update, remove } from "firebase/database"; // Added for Realtime Database
...
const firebaseConfig = {
  ...
  databaseURL: "https://elite-5b171-default-rtdb.europe-west1.firebasedatabase.app" // Added
};
